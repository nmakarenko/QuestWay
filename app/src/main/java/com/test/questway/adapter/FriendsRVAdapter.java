 ...
 */
public class FriendsRVAdapter extends RecyclerView.Adapter<FriendsRVAdapter.MainViewHolder> {
    ...
    public FriendsRVAdapter(Activity activity, OnItemClickListener listener) {
    ...
    public MainViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                ...
                return new ItemViewHolder(LayoutInflater.from(activity).inflate(R.layout.friends_item, parent, false));
