 ...
 */
public class ConversationsRVAdapter extends RecyclerView.Adapter<ConversationsRVAdapter.MainViewHolder> {
    ...
    public ConversationsRVAdapter(Activity activity, OnItemClickListener listener) {
    ...
    public MainViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ItemViewHolder(LayoutInflater.from(activity).inflate(R.layout.conversations_item, parent, false));
