 ...
 */
public class TeamsRVAdapter extends RecyclerView.Adapter<TeamsRVAdapter.MainViewHolder> {
    ...
    public TeamsRVAdapter(Activity activity, OnItemClickListener listener) {
    ...
    public MainViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ItemViewHolder(LayoutInflater.from(activity).inflate(R.layout.teams_item, parent, false));
